...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, MESSAGE_INVALID_CINEMA_DISPLAYED_INDEX);
    ...
    public void getFilteredCinemaList_modifyList_throwsUnsupportedOperationException() {
        ...
        logic.getFilteredCinemaList().remove(0);
    }
     ...
     *      - {@code expectedModel}'s movie planner was saved to the storage file.
     */
