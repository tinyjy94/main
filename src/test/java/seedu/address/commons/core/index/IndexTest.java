...
public class IndexTest {
    ...
    @Test
    public void equals() {
        final Index fifthCinemaIndex = Index.fromOneBased(5);

        // same values -> returns true
        assertTrue(fifthCinemaIndex.equals(Index.fromOneBased(5)));
        assertTrue(fifthCinemaIndex.equals(Index.fromZeroBased(4)));

        // same object -> returns true
        assertTrue(fifthCinemaIndex.equals(fifthCinemaIndex));

        // null -> returns false
        assertFalse(fifthCinemaIndex.equals(null));

        // different types -> returns false
        assertFalse(fifthCinemaIndex.equals(5.0f));

        // different index -> returns false
        assertFalse(fifthCinemaIndex.equals(Index.fromOneBased(1)));
    }
}
