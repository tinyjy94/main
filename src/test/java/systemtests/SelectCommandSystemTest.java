...
public class SelectCommandSystemTest extends AddressBookSystemTest {
    ...
    public void select() {
        ...
        /* Case: filtered cinema list, select index within bounds of address book but out of bounds of cinema list
         * -> rejected
         */
        ...
        /* Case: filtered cinema list, select index within bounds of address book and cinema list -> selected */
