 ...
 */
public class HelpCommandSystemTest extends MoviePlannerSystemTest {
    ...
    public void openHelpWindow() {
        ...
        getCinemaListPanel().click();
        getMainMenu().openHelpWindowUsingAccelerator();
        assertHelpWindowOpen();

        getMovieListPanel().click();
        getMainMenu().openHelpWindowUsingAccelerator();
        assertHelpWindowOpen();
        ...
        executeCommand(SelectCommand.COMMAND_WORD + " " + INDEX_FIRST_CINEMA.getOneBased());
        ...
        executeCommand(DeleteCommand.COMMAND_WORD + " " + INDEX_FIRST_CINEMA.getOneBased());
