...
Alternative 1: Store in the same xml file as the MoviePlanner and read upon startup of program to an array.
...
Alternative 2 *(current choice)*: Store in a separate xml file and update whenever movies are being added or deleted.
