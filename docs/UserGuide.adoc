...
Format: `addscreening n/MOVIE_NAME c/CINEMA th/THEATER sd/SCREEN_DATE h/SCREEN_HOUR`

Examples:

* `addscreening n/The Incredibles c/Cathay th/1 sd/18/11/2014 h/13:30`
* `as n/Spiderman 1 c/GV Bishan th/3 sd/04/29/2012 h/14:15`

[NOTE]
====
* `SCREEN_DATE` must not be before `START_DATE` of the movie
...
Format: `deletescreening n/MOVIE_NAME c/CINEMA th/NUMBER_OF_THEATER sd/SCREEN_DATE h/SCREEN_HOUR`

Examples:

* `deletescreening n/The Incredibles c/Cathay th/1 sd/14/08/2018 h/13:30`
* `ds n/Spider Man 1 c/GV Bishan th/2 sd/25/03/2018 h/14:15`

[NOTE]
====
* SCREEN_DATE must be on or after START_DATE of the movie
* The movie that is being screened must already exist in the MVP
* The cinema theater that is screening the movie must exist in the MVP
====
...
=== Finding movies by name: `findmovie`
...
|`addmovie n/The Incredibles d/115 r/PG sd/18/11/2014 cat/Animation`
|*AddScreening* |`addscreening n/MOVIE_NAME c/CINEMA th/THEATER sd/SCREEN_DATE h/SCREEN_HOUR` |`as`
|`addscreening n/The Incredibles c/Cathay th/1 sd/18/11/2014 h/13:30`
...
|`list` +
 `delete 2`
|*DeleteScreening* |`deletescreening n/MOVIE_NAME c/CINEMA th/NUMBER_OF_THEATER sd/SCREEN_DATE h/SCREEN_HOUR` |`ds`
|`deletescreening n/The Incredibles c/Cathay th/1 sd/14/08/2018 h/13:30`
