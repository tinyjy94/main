...
image::BeforeAddCinema.gif[width="800"]
...
image::BeforeEditCinema.gif[width="800"]
...
image::BeforeFindCinema.gif[width="800"]
...
image::BeforeDeleteCinema.gif[width="800"]
...
image::BeforeSelectCinema.gif[width="800"]
