...
This section shows how you can add, delete and modify cinemas in MVP.
...
* The index refers to the index number shown in the last cinema listing.
* The index *must be a positive number* `1, 2, 3, ...`
* Number of theater entered must be a *positive* number
...
|*Clear* |`clear`| `c`| `clear`
|*Decrypt* |`decrypt pw/PASSWORD` |`dec` |`decrypt pw/password`
...
|*Email* |`email msg/MESSAGE subj/SUBJECT recp/RECIPIENT func/<SEND/CLEAR> lgn/EMAIL_USERNAME:EMAIL_PASSWORD [attc/RELATIVE_FILE_PATH]`
|`eml` |`email msg/Hi Bob, Here is the schedule. subj/Schedule lgn/cmanager@gmail.com:1I2h@la recp/gv.manager@gmail.com attc/docs/images/Architecture.png func/send`
|*Encrypt* |`encrypt pw/PASSWORD`|`enc` |`encrypt pw/password`
